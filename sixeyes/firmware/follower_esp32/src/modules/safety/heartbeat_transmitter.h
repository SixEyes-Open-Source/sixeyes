...
public:
    ...
    void init();
    void update(bool fault, bool motors_enabled, bool ros2_alive);  // Call from control loop
...
public:
    ...
    void update(bool fault, bool motors_enabled);  // Call from control loop / SafetyTask
